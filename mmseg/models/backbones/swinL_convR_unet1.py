...
class SwinConvUnet1(BaseModule):
    ...
    def __init__(self,
        ...
        super(SwinConvUnet1, self).__init__(init_cfg=init_cfg)
        ...
        # self.conv_block0 = BasicConvBlock(in_channels=384, out_channels=384)
        self.conv_block = BasicConvBlock(in_channels=384, out_channels=768)
        self.conv_block1 = BasicConvBlock(in_channels=96, out_channels=64)
    ...
    def train(self, mode=True):
        ...
        super(SwinConvUnet1, self).train(mode)
        self._freeze_stages()
