_base_ = [
    '../../../_base_/models/upernet_vanUnet.py', '../../../_base_/datasets/brats2020_kaggle.py',
...
model = dict(
    ...
    decode_head=dict(
        ...
        loss_decode=[
            dict(type='CrossEntropyLoss', use_sigmoid=False, loss_name='loss_ce', class_weight=[1.0,1.0,1.0,1.0], loss_weight=1.0),
